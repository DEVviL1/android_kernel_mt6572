...
extern LCM_DRIVER ili9806c_dsi_vdo_djn_fwvga_oncell_lcm_drv;  // zhoulidong add
extern LCM_DRIVER ili9806c_dsi_vdo_azet_fwvga_oncell_lcm_drv;  // yangjuwei add
extern LCM_DRIVER ili9806c_dsi_vdo_by_fwvga_oncell_lcm_drv;  // yangjuwei add

extern LCM_DRIVER otm9605a_dsi_vdo_djn_qhd_lcm_drv;  // yangjuwei add
extern LCM_DRIVER otm9605a_dsi_vdo_hlt_qhd_lcm_drv;  // yangjuwei add
...
extern LCM_DRIVER ili9806e_dsi_vdo_6572_lcm_drv;  // add by DEVviL1

extern LCM_DRIVER otm8018b_dsi_vdo_by_fwvga_lcm_drv;	 	 // zhoulidong add
extern LCM_DRIVER otm8018b_dsi_vdo_txd_fwvga_lcm_drv;   // xiaoanxiang add
extern LCM_DRIVER ili9806c_dsi_vdo_txd_lcm_drv;	 	 // xiaoanxiang add
extern LCM_DRIVER ili9806c_dsi_vdo_azet_ips_lcm_drv;   // xiaoanxiang add
extern LCM_DRIVER ili9806c_dsi_vdo_djn_lcm_drv;		// xiaoanxiang add
extern LCM_DRIVER otm8018b_dsi_vdo_trust_lcm_drv;	// xiaoanxiang add

extern LCM_DRIVER hx8389b_dsi_vdo_txd_qhd_lcm_drv; // zhoulidong add 
extern LCM_DRIVER ili9806c_dsi_vdo_txd_ips_lcm_drv;//zhoulidong add 
...
extern LCM_DRIVER hx8379a_dsi_vdo_azet_ips_lcm_drv;//add by yangjuwei
extern LCM_DRIVER ili9806e_dsi_vdo_hlt_fwvga_oncell_lcm_drv;
extern LCM_DRIVER otm9605a_dsi_vdo_hlt_qhd_ips_lcm_drv;//add by wuhao
...
#endif
#if defined(OTM8018B_DSI_VDO_BY_FWVGA)	
	&otm8018b_dsi_vdo_by_fwvga_lcm_drv, 
#endif
...
//juwei yang add
#if defined(OTM9605A_DSI_VDO_HLT_QHD)
		&otm9605a_dsi_vdo_hlt_qhd_lcm_drv,
#endif
